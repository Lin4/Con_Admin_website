...
$url = 'http://primetech.digisarathi.net/contructionapi.php/api/project/get/edit/'.$project_id;
$responseArray = $curl->curlGetMethod($url);
$edit = $responseArray['project'][0];
//print_r($edit);
$page_title = 'Edit Project : '. $edit['p_name'];
...
if(empty($_POST['inputEditId'])){
	...
	$url = 'http://primetech.digisarathi.net/contructionapi.php/api/project/update/Art/'.$project_id.'/'.$project_id.'/'.$name.'/'.$description.'/'.$title.'/'.$street.'/'.$city.'/'.$state.'/'.$zip.'/'.$phoneno.'/'.$date.'/'.$clientName.'/'.$projectManager.'/'.$lat.'/'.$long.'/'.$inspector;
//echo $url;
	}
...
$lat = !empty($edit['p_latitude']) ? $edit['p_latitude'] : 20.0;
$long = !empty($edit['p_longitude']) ? $edit['p_longitude'] : -10.0;
?>
...
function xz() {
ll = new google.maps.LatLng(<?php echo $lat; ?>, <?php echo $long; ?>);
zoom=2;
var mO = {
scaleControl:true,
zoom:zoom,
...
var t1 = String(point);
t1 = t1.replace(/[() ]+/g,"");
var str = "http://www.vpike.com/?e=" + t1 + ":0:Latitude-Longitude Point:sv:0";
...
<legend><?php echo $page_title; ?> <a href="index.php?page_name=manage-projects" class="btn btn-success btn-xs pull-right">Manage Project</a></legend>
...
<input type="hidden" class="form-control" name="inputEditId" value="<?php echo !empty($edit['id']) ? $edit['id'] : ""; ?>">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputProjectId" value="<?php echo !empty($edit['projecct_id']) ? $edit['projecct_id'] : ""; ?>" readonly >
    </div>
  </div>
  <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Title</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputTitle" value="<?php echo !empty($edit['p_title']) ? $edit['p_title'] : ""; ?>">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea class="form-control" name="inputDescription" rows="3"><?php echo !empty($edit['p_description']) ? $edit['p_description'] : ""; ?></textarea>
    </div>
  </div>
    <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Street</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputStreet" value="<?php echo !empty($edit['street']) ? $edit['street'] : ""; ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">State</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputState" value="<?php echo !empty($edit['state']) ? $edit['state'] : ""; ?>">
    </div>
  </div>
   <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">City</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputCity" value="<?php echo !empty($edit['city']) ? $edit['city'] : ""; ?>">
    </div>
  </div>

    <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Zip</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputZip" value="<?php echo !empty($edit['zip']) ? $edit['zip'] : ""; ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Phone no</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputPhoneNo" value="<?php echo !empty($edit['phone']) ? $edit['phone'] : ""; ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Date</label>
    <div class="col-sm-10">
      <input type="text" class="form-control datepicker" name="inputDate" value="<?php echo !empty($edit['p_date']) ? date('Y-m-d', strtotime($edit['p_date'])) : ""; ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Client Name</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputClientName" value="<?php echo !empty($edit['client_name']) ? $edit['client_name'] : ""; ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Project Manager</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputProjectManager" value="<?php echo !empty($edit['project_manager']) ? $edit['project_manager'] : ""; ?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputtext3" class="col-sm-2 control-label">Inspector</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputInspector" value="<?php echo !empty($edit['inspecter']) ? $edit['inspecter'] : ""; ?>">
    </div>
  </div>
		<div class="google_map">
			<div id="map" style="width: 100%; height: 450px"></div>
			<input size="15" type="hidden" id="latbox" name="inputLat" value="<?php echo $lat; ?>" >
			<input size="15" type="hidden" id="lonbox" name="inputLong" value="<?php echo $long; ?>" >
			<!--hidden-->
